  ...
  return (
    <div id="app-layout" className="min-h-screen bg-background flex text-secondary-foreground">
      ...
      <aside
        id="sidebar"
        className={cn(
          "bg-[#0a0b10] border-r border-white/5 w-72 transition-all duration-300 ease-in-out z-50 flex flex-col shadow-2xl shrink-0 overflow-hidden h-screen sticky top-0",
